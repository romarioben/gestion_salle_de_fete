...
<body>
	...
	<div class="container">
		<h1 class="text-center">La liste complète des réservations<h1>
		<div>
			<div class="row mb-2">
				<a  href="/reservation/create" class="btn btn-primary col">
					...
					<c:forEach var="reservation" items="${reservations}" varStatus="status">
						<tr>
						  ...
						  <td>${reservation.heureFin}</td>
	  				      <td><a title="Editer la réservation" href="/reservation/${reservation.id}">Editer</a></td>
	  				      <td><a title="Supprimer la réservation" class="text-danger" href="/reservation/delete/${reservation.id}">Supprimer</a></td>
					    </tr>					  
